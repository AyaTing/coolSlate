...
from services.calendar_service import get_available_calendar, check_slot_availability, get_daily_available_slots, check_booking_feasibility, check_date_bookable, calculate_service_max_units, get_service_types_config
...
async def check_multiple_dates_availability(
    ...
    try:
        ...
        for check_date in dates:
            is_available = await check_date_bookable(check_date, service_type.value, 1, db)
    ...
    try:
        ...
        while current_date <= to_date:
            ...
            for service_name in service_names:
                is_available = await check_date_bookable(current_date, service_name, 1, db)
